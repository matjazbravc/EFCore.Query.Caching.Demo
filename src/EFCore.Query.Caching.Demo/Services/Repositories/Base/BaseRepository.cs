...
namespace EFCoreQueryCachingDemo.Services.Repositories.Base;
  ...
  where TDbContext : DbContext
{
  ...
  public async Task<int> CountAsync(Expression<Func<TEntity, bool>> predicate, bool tracking = false, CancellationToken cancellationToken = default)
  {
  ...
  public async Task<IList<TResult>> GetAsync<TResult>(
